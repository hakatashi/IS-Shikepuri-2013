# more_animated_quicksort.rb
# This version reflects the number of comparisons by raising hands of 
# persons to be compared (or that have been compared), so that you will feel
...
def qsort(a, from, to)
  if from < to
    ...
    while l <= r do
      while a[l] < med
        a[l].raise_hand(); a[l].lower_hand()  # raise hand and lower it soon
        l = l + 1
      end
      while a[r] > med
        a[r].raise_hand(); a[r].lower_hand()  # raise hand and lower it soon
        r = r - 1
      end
